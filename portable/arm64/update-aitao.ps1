# ============================================================================
# update-aitao.ps1 - AiTao auto-update (Windows ARM64, portable mode)
#
# Checks GitHub Releases for a newer version, downloads the ARM64 archive,
...
# Find the root folder inside the zip (e.g. aitao-v2.6.0-windows-arm64/)
